...
<section id="create-event-address-page">
	<h1>Create an Address for your Event!</h1>
	
	<c:url var="eventAddressUrl" value="/eventAddress/${eventId}"/>
	<form method="POST" action="${eventAddressUrl}">
		...
		<div class="state">
			...
			<select value="${address.state}" name="state" id="state">
		...
		<div class="eventAddressSubmit">
			<input type="submit" value="Submit Event Address"/>
		</div>
	</form>
